...
##################################################################################
*/
#ifndef _Writer_ASCII_VTK_H_
#define _Writer_ASCII_VTK_H_
 ...
 */
class Writer_ASCII_VTK : public Writer_VTK
{
	public:
		 ...
		 */
		Writer_ASCII_VTK(Problem* prob);
		virtual ~Writer_ASCII_VTK();
		Writer_ASCII_VTK(const Writer_ASCII_VTK& other);
